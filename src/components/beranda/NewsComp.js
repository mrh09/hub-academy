                ...
                <div className="news-body-section">
                    <div className="card-news">
                        <div className="card-news-container">
                            <img className="card-news-img" src='/img/berita-1.png' alt="education" />
                    ...
                    <div className="card-news">
                        <div className="card-news-container">
                            <img className="card-news-img" src='/img/berita-2.png' alt="education" />
                    ...
                    <div className="card-news">
                        <div className="card-news-container">
                            <img className="card-news-img" src='/img/berita-3.png' alt="education" />
